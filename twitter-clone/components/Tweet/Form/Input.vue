    ...
    <div :class="popUpStyleBorder">
        ...
        <div class="flex justify-between items-center pl-14 pr-6 pb-3">
            <div class="flex">
                ...
                <div :class="popUpStyleMaxChars" class="flex border-r h-2 pr-2 self-center justify-end items-center p-2 text-blue-500 cursor-pointer">
...
const popUpStyleMaxChars = computed(() => props.popup ? 'w-24' : 'w-56')
